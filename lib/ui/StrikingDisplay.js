...
(function() {
  cas.StrikingDisplay = (function() {
    ...
    StrikingDisplay.prototype.measureUp = function() {
      ...
      this.canvas.height = 20 + this.fHeightPerRow * this.fData.getNRows();
      return true;
    };
      ...
      for (j = _i = 0, _ref = row.getRowSize(); 0 <= _ref ? _i < _ref : _i > _ref; j = 0 <= _ref ? ++_i : --_i) {
        ...
        if (this.fLastActualX[j] > 0) {
          ...
          if (!this.fInChangesOnly || this.fInChanges) {
            ...
            this.drawLine(this.fLastActualX[this.fLastPlace[b - 1]], y - this.fHeightPerRow * 3 / 2, this.fThisActualX[j], y - this.fHeightPerRow / 2, b === this.fHighlightedBell ? this.BLACK : this.GRID_COLOUR);
          }
        }
      }
